...
- The Agent may use `memory-get-context` internally, but the automatic context retrieval must not be rendered as a persistent tool-call chip in the conversation.
